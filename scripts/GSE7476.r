...
n_tumor <- sum(matriz_modelo_GSE7476[, "tumor"])
n_nontumor <- sum(matriz_modelo_GSE7476[, "non_tumor"])
...
rownames(metafor_GSE7476) <- rownames(fit2$coefficients)
...
saveRDS(
  metafor_GSE7476,
  file = file.path(out_dir, "metafor_GSE7476.rds")
)
