...
n_tumor <- sum(matriz_modelo_GSE65635[, "tumor"])
n_nontumor <- sum(matriz_modelo_GSE65635[, "non_tumor"])
...
saveRDS(
  metafor_GSE65635,
  file = file.path(out_dir, "metafor_GSE65635.rds")
)
...
deg_GSE65635 <- deg_GSE65635[!is.na(deg_GSE65635$ENTREZID), ]

# opcional: ordenar por FDR
deg_GSE65635 <- deg_GSE65635[order(deg_GSE65635$FDR), ]

# salvar
write.csv(
  deg_GSE65635,
  file = file.path(results_dir, "DEGs_tables", "DEGs_GSE65635.csv"),
  row.names = FALSE
)