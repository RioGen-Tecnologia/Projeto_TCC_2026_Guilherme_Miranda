...
n_tumor <- sum(matriz_modelo_GSE52519[, "tumor"])
n_nontumor <- sum(matriz_modelo_GSE52519[, "non_tumor"])
...
rownames(metafor_GSE52519) <- rownames(fit2$coefficients)
...
saveRDS(
  metafor_GSE52519,
  file = file.path(out_dir, "metafor_GSE52519.rds")
)
