...
deg_GSE13507 <- deg_GSE13507[!is.na(deg_GSE13507$ENTREZID), ]

# opcional: ordenar por FDR
deg_GSE13507 <- deg_GSE13507[order(deg_GSE13507$FDR), ]

# salvar
write.csv(
  deg_GSE13507,
  file = file.path(results_dir, "DEGs_tables", "DEGs_GSE13507.csv"),
  row.names = FALSE
)