...
rownames(metafor_GSE76211) <- rownames(fit2$coefficients)
...
saveRDS(
  metafor_GSE76211,
  file = file.path(out_dir, "metafor_GSE76211.rds")
)
...
deg_GSE76211 <- deg_GSE76211[!is.na(deg_GSE76211$ENTREZID), ]

# opcional: ordenar por FDR
deg_GSE76211 <- deg_GSE76211[order(deg_GSE76211$FDR), ]

# salvar
write.csv(
  deg_GSE76211,
  file = file.path(results_dir, "DEGs_tables", "DEGs_GSE76211.csv"),
  row.names = FALSE
)
